 ...
 * House ------------------------------------------------------------------------------------
 */
const house = new THREE.Group(); // creating a group to add all the objects in side.
scene.add(house);
//
//walls
...
// Door light ----------------------------------------------------------------------------
const doorLight = new THREE.PointLight("#ff7d46", 1, 7); // intensity, distance of light to fade
...
const tick = () => {
  ...
  ghost3.position.y = Math.sin(elapsedTime * 3) + Math.sin(elapsedTime * 1.1)
